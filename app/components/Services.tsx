  ...
  const services = [
    {
      ...
      image: "/anxiety.jpg", // update to your actual file name
    },
    {
      ...
      image: "/relationship.png", // update to your actual file name
    },
    {
      ...
      image: "/trauma.png", // update to your actual file name
    },
  ];

  return (
    <section className="py-16 px-4 md:px-12 bg-[#e0f7fa] text-black" id="services">
