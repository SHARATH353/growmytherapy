...
export default function About() {
  return (
    <section className="py-16 px-4 md:px-12 bg-[#e0f7fa] text-black" id="about">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          <Image
            src="/dr-serena-blake.png" // <-- update to your actual file name
            alt="Dr. Serena Blake"
            width={400}
            height={400}
        ...
        <div className="md:w-1/2 md:pl-10">
          ...
          <p className="mb-4">
            ...
            with 8 years of experience and over 500 client sessions. She blends
